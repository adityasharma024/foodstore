...
const LocationSearch = ({ childState, setChildState }) => {
  ...
  async function getLocation() {
    setIsLoading(true);
    const url = `https://india-pincode-with-latitude-and-longitude.p.rapidapi.com/api/v1/pincode/${searchText}`;
    const options = {
      method: 'GET',
      headers: {
        'x-rapidapi-key': '98ee90a82emsh5fddeca0d64ea20p140ff2jsn72f0065e360e',
